...
- Analysis script: `src/h001_runtime/analyze_uncertainty.py`
...
- Coverage sanity log: `archive/logs/h001_runtime/calibration-random256-coverage-sanity-20260510-143038.log`
- Artifact coverage log: `archive/logs/h001_runtime/calibration-random256-artifact-coverage-20260510-143058.log`
...
- Coverage sanity log: `archive/logs/h001_runtime/calibration-random256-k10-coverage-sanity-20260511-010532.log`
- Artifact coverage log: `archive/logs/h001_runtime/calibration-random256-k10-artifact-coverage-20260511-010633.log`
- Diagnostic policy log: `archive/logs/h001_runtime/calibration-random256-k10-policy-comparison-diagnostic-20260511-010704.log`
...
next_code_target: src/h001_runtime/run_smoke.py
...
```text
date_checked: 2026-05-11
module: src/h001_runtime/export_postview_frames.py
...
box_threshold: 0.10
text_threshold: 0.10
job_script: scripts/h001_jobs/postview_v3c_groundingdino_sam2_calib50.sh
...
script_updated: src/h001_runtime/analyze_object_node_confirmation.py
new_manifest: configs/h001/manifests/h001_confirmation_independent_v1.json
new_manifest_verify: configs/h001/manifests/h001_confirmation_independent_v1.verify.json
...
scene_specs: configs/h001/manifests/risk_validation_v1_scenes.txt
frames: 256
selection_mode: spatial_nms
top_percentile: 97.0
max_candidates: 20
...
```text
date_checked: 2026-05-15
planner: src/h001_runtime/plan_association_recovery_observation.py
after_second_analyzer: src/h001_runtime/analyze_association_recovery_observation.py
...
```text
date_checked: 2026-05-16
script: src/h001_runtime/analyze_association_recovery_failure_modes.py
...
```text
date_checked: 2026-05-16
script: src/h001_runtime/analyze_association_recovery_arbitration.py
...
integrated_analyzer: src/h001_runtime/analyze_association_recovery_observation.py
job_wrapper: scripts/h001_jobs/risk_validation_association_recovery_observation_v1.sh
...
```text
date_checked: 2026-05-18
design_diagnostic: src/h001_runtime/analyze_pair_observation_design.py
...
```text
date_checked: 2026-05-18
planner_module: src/h001_runtime/plan_pair_observation.py
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_pair_observation_evidence.py
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_pair_observation_failure_modes.py
output_root: /tmp/research3-runs/h001_pair_observation_detector_evidence_v1
rows: 11
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_pair_observation_objective_v2.py
output_root: /tmp/research3-runs/h001_pair_observation_detector_evidence_v1
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_pair_observation_v2_overdeferral.py
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_pair_observation_objective_v3.py
...
```text
date_checked: 2026-05-18
code: src/h001_runtime/plan_pair_observation.py
...
```text
date_checked: 2026-05-18
code: src/h001_runtime/analyze_pair_observation_objective_v4.py
...
```text
date_checked: 2026-05-18
code: src/h001_runtime/analyze_pair_observation_objective_v4b.py
...
frame_exporter_update: src/h001_runtime/export_postview_frames_v2.py preserves external_* and source_objective_* fields
detector_update: src/h001_runtime/detect_postview_groundingdino_sam2.py preserves external_* and source_objective_* fields
...
```text
date_checked: 2026-05-19
job_script: scripts/h001_jobs/v3_fresh_external_candidate_followup_v2_stage2.sh
job_status: completed
