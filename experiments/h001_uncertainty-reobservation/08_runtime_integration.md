...
- Runtime scripts and Dockerfiles are stored under `experiments/h001_uncertainty-reobservation/runtime/`.
...
- Runtime module: `src/h001_runtime/run_smoke.py`
...
- `VLMaps` artifact exporter: `src/h001_runtime/export_vlmaps_artifact.py`
- Text embedding exporter: `runtime/export_text_embeddings.py`
- HM3D trajectory exporter: `src/h001_runtime/export_hm3d_vlmaps.py`
- Alignment adapter: `src/h001_runtime/align_vlmaps_artifact.py`
- Habitat navigability smoke: `src/h001_runtime/smoke_vlmaps_alignment.py`
...
log: archive/logs/h001_runtime/calibration-artifacts-random256-20260509-233124.log
...
sg docker -c "docker run --rm --gpus all --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.run_smoke \
    --data-root /data \
    --manifest /workspace/configs/h001/manifests/h001_splits_v1.json \
...
coverage_sanity_log: archive/logs/h001_runtime/calibration-random256-coverage-sanity-20260510-143038.log
artifact_coverage_log: archive/logs/h001_runtime/calibration-random256-artifact-coverage-20260510-143058.log
overall_pass: false
...
log: archive/logs/h001_runtime/calibration-artifacts-random256-k10-20260510-165427.log
output_root: /tmp/research3-runs/h001_calibration_artifacts_random256_k10_v1
...
coverage_sanity_log: archive/logs/h001_runtime/calibration-random256-k10-coverage-sanity-20260511-010532.log
artifact_coverage_log: archive/logs/h001_runtime/calibration-random256-k10-artifact-coverage-20260511-010633.log
diagnostic_policy_log: archive/logs/h001_runtime/calibration-random256-k10-policy-comparison-diagnostic-20260511-010704.log
candidate_label_coverage: 1.0
...
manifest: configs/h001/manifests/h001_splits_sr1.json
scene_specs: configs/h001/manifests/sr1_scenes.txt
...
LOG="archive/logs/h001_runtime/calibration-artifacts-random256-k10-sr1-${TS}.log"
OUT="/tmp/research3-runs/h001_calibration_artifacts_random256_k10_sr1_v1"
SCENES="/home/yoohyun/research3/configs/h001/manifests/sr1_scenes.txt"
mkdir -p archive/logs/h001_runtime "$OUT"
printf '%s\n' "$SESSION" > "$OUT/tmux_session.txt"
printf '%s\n' "$LOG" > "$OUT/log_path.txt"
tmux new-session -d -s "$SESSION" \
  "bash -lc 'set -o pipefail; cd /home/yoohyun/research3 && SCENE_SPECS_FILE=\"$SCENES\" ARTIFACT_ID=random256_k10_sr1_v1 TRAJECTORY_SUFFIX=calib_random256_k10_sr1_v1 FRAMES=256 MAX_CANDIDATES=10 TOP_PERCENTILE=98.0 OUT_ROOT=/tmp/research3-runs/h001_calibration_artifacts_random256_k10_sr1_v1 ./scripts/h001_tools/calibration_artifact_job.sh 2>&1 | tee -a \"$LOG\"; rc=\$?; echo \"[\$(date -Is)] job exit status: \$rc\" | tee -a \"$LOG\"; exit \$rc'"
```
...
working_directory: /home/yoohyun/research3
log: archive/logs/h001_runtime/calibration-artifacts-random256-k10-sr1-20260511-115330.log
output_root: /tmp/research3-runs/h001_calibration_artifacts_random256_k10_sr1_v1
scene_specs: configs/h001/manifests/sr1_scenes.txt
manifest: configs/h001/manifests/h001_splits_sr1.json
...
sg docker -c "docker run --rm --gpus all --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.run_smoke \
    --data-root /data \
    --manifest /workspace/configs/h001/manifests/h001_splits_sr1.json \
    --manifest-split calibration \
    --episodes 50 \
    --policies GTTargetOracle NoReobserve \
...
```text
runtime_file: src/h001_runtime/run_smoke.py
...
```text
Habitat renderer/exporter: src/h001_runtime/export_hm3d_vlmaps.py
VLMaps map scorer: src/h001_runtime/export_vlmaps_artifact.py
...
```text
src/h001_runtime/export_postview_frames.py
src/h001_runtime/score_postview_vlm.py
```
...
```bash
sg docker -c 'docker run --rm --gpus all --ipc=host --user <uid>:<gid> -e HOME=/tmp -e PYTHONPATH=/workspace/src -v /tmp/research3-data:/data:ro -v /tmp/research3-runs:/runs -v /home/yoohyun/research3:/workspace:ro research3/habitat-h001:20260508-calib-artifacts micromamba run -n base python -m h001_runtime.export_postview_frames --data-root /data --viewpoint-decisions /runs/h001_calibration_policy_random256_k10_sr1_v1/policy_revision/viewpoint_decisions.jsonl --candidate-artifact /runs/h001_calibration_artifacts_random256_k10_sr1_v1/all_scenes_aligned.jsonl --out-root /runs/h001_postview_scores_random256_k10_sr1_v1 --policy EvidenceGatedSemanticOnly'
```
...
script: src/h001_runtime/analyze_postview_scores.py
...
```text
new_frame_exporter: src/h001_runtime/export_postview_frames_v2.py
new_scorer: src/h001_runtime/score_postview_v2.py
...
```text
frame_exporter: src/h001_runtime/export_postview_frames_v2.py
scorer: src/h001_runtime/score_postview_v2.py
policy_loader_update: src/h001_runtime/run_smoke.py supports --semantic-image-score-rule agg_local_delta
```
...
```text
diagnostic_script: src/h001_runtime/analyze_postview_scores_v2.py
...
job_script: scripts/h001_jobs/postview_v2_fullcalib.sh
working_directory: /home/yoohyun/research3
...
```text
scripts/h001_jobs/postview_v2_fullcalib.sh
```
...
```text
date_checked: 2026-05-13
script: src/h001_runtime/analyze_postview_scores_v2.py
...
```text
date_checked: 2026-05-13
script: src/h001_runtime/analyze_postview_visibility_v2.py
...
job_script: scripts/h001_jobs/postview_v2_1_relaxed_position.sh
working_directory: /home/yoohyun/research3
...
```text
scripts/h001_jobs/postview_v2_1_relaxed_position.sh
```
...
```text
script: src/h001_runtime/score_postview_v3_depth_mask.py
...
job_script: scripts/h001_jobs/postview_v3a_depth_mask_fullcalib.sh
working_directory: /home/yoohyun/research3
...
```text
scripts/h001_jobs/postview_v3a_depth_mask_fullcalib.sh
```
...
job_script: scripts/h001_jobs/openvocab_perception_owlvit_setup.sh
...
```text
scripts/h001_jobs/openvocab_perception_owlvit_setup.sh
```
...
```text
src/h001_runtime/detect_postview_owlvit_box.py
...
job_script: scripts/h001_jobs/openvocab_perception_v3c_groundingdino_sam2_setup.sh
...
```text
src/h001_runtime/detect_postview_groundingdino_sam2.py
...
```text
scripts/h001_jobs/postview_v3c_groundingdino_sam2_calib50.sh
...
tmux new-session -d -s h001-v3c-calib50-gpu \
  "cd /home/yoohyun/research3 && DEVICE=cuda scripts/h001_jobs/postview_v3c_groundingdino_sam2_calib50.sh"
```
...
```text
date_checked: 2026-05-15
analysis_script: src/h001_runtime/analyze_postview_detector_v3c.py
...
```text
date_checked: 2026-05-15
script: src/h001_runtime/cross_validate_postview_detector_v3c.py
...
split: first_eval
manifest: configs/h001/manifests/h001_splits_sr1.json
scene_specs: configs/h001/manifests/first_eval_scenes.txt
...
SCENES="/home/yoohyun/research3/configs/h001/manifests/first_eval_scenes.txt"
mkdir -p logs "$OUT"
tmux new-session -d -s "$SESSION" \
  "bash -lc 'set -o pipefail; cd /home/yoohyun/research3 && SCENE_SPECS_FILE=\"$SCENES\" ARTIFACT_ID=first_eval_random256_k10_v1 TRAJECTORY_SUFFIX=first_eval_random256_k10_v1 FRAMES=256 MAX_CANDIDATES=10 TOP_PERCENTILE=98.0 EXPECTED_SCENE_COUNT=10 EXPECTED_QUERY_ROWS=60 OUT_ROOT=\"$OUT\" ./scripts/h001_tools/calibration_artifact_job.sh 2>&1 | tee -a \"$LOG\"; rc=\$?; echo \"[\$(date -Is)] job exit status: \$rc\" | tee -a \"$LOG\"; exit \$rc'"
```
...
```text
runtime_file: src/h001_runtime/export_vlmaps_artifact.py
...
script: scripts/h001_jobs/first_eval_spatial_nms_reexport.sh
coverage_script: scripts/h001_jobs/first_eval_coverage_sanity.sh
...
scene_specs: configs/h001/manifests/replacement_probe_scenes.txt
...
manifest: configs/h001/manifests/h001_first_eval_replacement_v1.json
scene_specs: configs/h001/manifests/first_eval_replacement_v1_scenes.txt
...
```text
script: scripts/h001_jobs/first_eval_replacement_v3c_detector_artifact.sh
...
```text
script: src/h001_runtime/analyze_detector_association_variants.py
docker_image: research3/habitat-h001:20260508-calib-artifacts
...
```text
script: src/h001_runtime/analyze_detector_evidence_revision.py
docker_image: research3/habitat-h001:20260508-calib-artifacts
...
```text
script: src/h001_runtime/validate_detector_evidence_robustness.py
docker_image: research3/habitat-h001:20260508-calib-artifacts
...
```text
script: src/h001_runtime/analyze_object_node_evidence_objective.py
...
```text
script: src/h001_runtime/analyze_object_node_confirmation.py
...
```text
manifest: configs/h001/manifests/h001_confirmation_independent_v1.json
verify: configs/h001/manifests/h001_confirmation_independent_v1.verify.json
...
```text
script: scripts/h001_jobs/confirmation_independent_v3c_detector_artifact.sh
...
```text
date_checked: 2026-05-15
script: src/h001_runtime/run_smoke.py
...
scene_file: configs/h001/manifests/risk_validation_v1_scenes.txt
verify: configs/h001/manifests/h001_risk_validation_v1.verify.json
...
tmux new-session -d -s h001-confirmation-independent-v3c-${ts} \
  "cd /home/yoohyun/research3 && TS=${ts} scripts/h001_jobs/confirmation_independent_v3c_detector_artifact.sh"
```
...
HM3D / ObjectNav:
  job_script: scripts/h001_jobs/hm3d_restore.sh
...
- Runtime file: `src/h001_runtime/run_smoke.py`
...
job_wrapper: scripts/h001_jobs/risk_validation_association_recovery_observation_v1.sh
...
working_directory: /home/yoohyun/research3
command: TS=20260516-093917 LOG=/home/yoohyun/research3/logs/risk-validation-association-recovery-observation-v1-20260516-093917.log OUT=/tmp/research3-runs/h001_risk_validation_association_recovery_observation_v1 MAX_ROWS=20 scripts/h001_jobs/risk_validation_association_recovery_observation_v1.sh
...
working_directory: /home/yoohyun/research3
command: TS=20260516-100438 OUT=/tmp/research3-runs/h001_risk_validation_association_recovery_observation_standoff_v1 RUN_ID=h001_risk_validation_association_recovery_observation_standoff_v1_20260516-100438 LOG=/home/yoohyun/research3/logs/risk-validation-association-recovery-observation-standoff-v1-20260516-100438.log MAX_ROWS=20 DEVICE=cuda bash scripts/h001_jobs/risk_validation_association_recovery_observation_v1.sh
...
working_directory: /home/yoohyun/research3
job_wrapper: scripts/h001_jobs/pair_observation_detector_evidence_v1.sh
command: TS=20260518-014114 OUT=/tmp/research3-runs/h001_pair_observation_detector_evidence_v1 LOG=/home/yoohyun/research3/logs/pair-observation-detector-evidence-v1-20260518-014114.log DEVICE=cuda scripts/h001_jobs/pair_observation_detector_evidence_v1.sh
...
heldout_manifest: configs/h001/manifests/h001_first_eval_replacement_v1.json
heldout_manifest_verify: configs/h001/manifests/h001_first_eval_replacement_v1.verify.json
heldout_scenes: 10
...
working_directory: /home/yoohyun/research3
job_wrapper: scripts/h001_jobs/first_eval_replacement_pair_objective_v2_substrate.sh
command: TS=20260518-020840 OUT=/tmp/research3-runs/h001_first_eval_replacement_pair_objective_v2_validation_v1 LOG=/home/yoohyun/research3/logs/first-eval-replacement-pair-objective-v2-substrate-20260518-020840.log DEVICE=cuda MAX_ASSOC_ROWS=40 scripts/h001_jobs/first_eval_replacement_pair_objective_v2_substrate.sh
...
```text
date_checked: 2026-05-18
manifest: configs/h001/manifests/h001_v3_fresh_validation_v1.json
verify: configs/h001/manifests/h001_v3_fresh_validation_v1.verify.json
scene_list: configs/h001/manifests/v3_fresh_validation_v1_scenes.txt
...
```text
date_launched: 2026-05-18
job_wrapper: scripts/h001_jobs/v3_fresh_validation_candidate_artifact_coverage.sh
...
scene_specs_file: configs/h001/manifests/v3_fresh_validation_v1_scenes.txt
frames: 256
selection_mode: spatial_nms
top_percentile: 97.0
max_candidates: 20
...
```text
date_launched: 2026-05-18
job_wrapper: scripts/h001_jobs/v3_fresh_validation_pair_objective_v3.sh
...
```text
date_checked: 2026-05-18
planner: src/h001_runtime/plan_pair_observation.py
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_pair_observation_objective_v4.py
...
```text
date_launched: 2026-05-18
job_wrapper: scripts/h001_jobs/v3_fresh_validation_pair_objective_v4_revised_geometry.sh
...
tmux new-session -d -s h001-v3-fresh-pair-v4-geo-20260518-135204 \
  "cd /home/yoohyun/research3 && TS=20260518-135204 bash scripts/h001_jobs/v3_fresh_validation_pair_objective_v4_revised_geometry.sh"
```
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_pair_observation_objective_v4b.py
...
```text
date_checked: 2026-05-18
planner: src/h001_runtime/plan_external_candidate_observation.py
scoring_analyzer: src/h001_runtime/analyze_external_candidate_scoring_v1.py
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_external_candidate_observation_evidence.py
...
```text
date_launched: 2026-05-18
job_wrapper: scripts/h001_jobs/v3_fresh_validation_pair_objective_v4b_external_candidate_detector.sh
tmux_session: h001-v3-fresh-v4b-external-detector-20260518-163832
command: TS=20260518-163832 bash scripts/h001_jobs/v3_fresh_validation_pair_objective_v4b_external_candidate_detector.sh
working_directory: /home/yoohyun/research3
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_external_candidate_observation_evidence_v2.py
...
frozen_analyzer: src/h001_runtime/analyze_external_candidate_observation_evidence_v2.py
job_wrapper: scripts/h001_jobs/risk_validation_pair_objective_v4b_external_candidate_v2_holdout.sh
...
```bash
TS=<timestamp> bash scripts/h001_jobs/risk_validation_pair_objective_v4b_external_candidate_v2_holdout.sh
```
...
```bash
TS=<timestamp> \
MANIFEST=/home/yoohyun/research3/configs/h001/manifests/h001_risk_validation_v1.json \
...
bash scripts/h001_jobs/v3_fresh_validation_pair_objective_v4_revised_geometry.sh
...
bash scripts/h001_jobs/v3_fresh_validation_pair_objective_v4b_external_candidate_detector.sh
...
command: TS=20260518-171245 bash scripts/h001_jobs/risk_validation_pair_objective_v4b_external_candidate_v2_holdout.sh
working_directory: /home/yoohyun/research3
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_external_candidate_observation_evidence_v3.py
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_external_candidate_observation_evidence_v4.py
...
```text
date_checked: 2026-05-18
planner: src/h001_runtime/plan_external_candidate_followup_observation.py
...
```text
date_checked: 2026-05-18
analyzer: src/h001_runtime/analyze_external_candidate_followup_evidence.py
...
wrapper: scripts/h001_jobs/risk_validation_external_candidate_followup_detector.sh
...
```text
date_checked: 2026-05-19
analyzer: src/h001_runtime/analyze_external_candidate_followup_failure_modes.py
...
```text
date_checked: 2026-05-19
planner: src/h001_runtime/plan_external_candidate_second_stage_identity_confirmation.py
policy: ExternalCandidateSecondStageIdentityConfirmation
...
```text
date_checked: 2026-05-19
analyzer: src/h001_runtime/analyze_external_candidate_second_stage_identity_evidence.py
...
```text
date_checked: 2026-05-19
detector: src/h001_runtime/detect_postview_groundingdino_sam2.py
analyzer: src/h001_runtime/analyze_external_candidate_second_stage_identity_evidence.py
...
```text
date_checked: 2026-05-19
script: src/h001_runtime/summarize_followup_v2_stage2.py
...
```text
date_checked: 2026-05-19
script: src/h001_runtime/inspect_followup_v2_stage2_feasibility.py
...
script: scripts/h001_jobs/v3_fresh_external_candidate_followup_v2_stage2.sh
tmux_session: h001-v3-fresh-followup-v2-stage2-20260519-125841
command: TS=20260519-125841 bash scripts/h001_jobs/v3_fresh_external_candidate_followup_v2_stage2.sh
working_directory: /home/yoohyun/research3
...
command: TS=20260519-132201 bash scripts/h001_jobs/v3_fresh_external_candidate_followup_v3_stage2.sh
log: archive/logs/h001_runtime/v3-fresh-external-candidate-followup-v3-stage2-20260519-132201.log
...
command: TS=20260519-143805 bash scripts/h001_jobs/first_eval_replacement_objective_v2_heldout.sh
log: archive/logs/h001_runtime/first-eval-replacement-objective-v2-heldout-20260519-143805.log
status: running/pair_v4b_revised_geometry
manifest: configs/h001/manifests/h001_first_eval_replacement_v1.json
derivation_manifest: configs/h001/manifests/h001_v3_fresh_validation_v1.json
...
```text
date_checked: 2026-05-19
file: src/h001_runtime/detect_postview_groundingdino_sam2.py
change:
...
docker_command:
  docker run --rm --ipc=host --user "$(id -u):$(id -g)" -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPATH=/workspace/src -v /tmp/research3-runs:/runs -v /home/yoohyun/research3:/workspace:ro research3/habitat-h001:20260508-calib-artifacts micromamba run -n base python -m h001_runtime.diagnose_identity_ambiguity --followup-evidence-rows /runs/h001_first_eval_replacement_pair_objective_v4b_external_candidate_detector_heldout_v1/external_candidate_followup_evidence_v3_explicit_candidates/external_candidate_followup_evidence_rows.jsonl --out-root /runs/h001_first_eval_replacement_pair_objective_v4b_external_candidate_detector_heldout_v1/identity_ambiguity_diagnostic_v1 --min-contrastive-margin 0.05
rows: 5
action_counts:
  followup_evidence_v1_defer: 5
failure_mode_counts:
...
docker_command:
  docker run --rm --ipc=host --user "$(id -u):$(id -g)" -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPATH=/workspace/src -v /tmp/research3-runs:/runs -v /home/yoohyun/research3:/workspace:ro research3/habitat-h001:20260508-calib-artifacts micromamba run -n base python -m h001_runtime.design_identity_resolution --followup-evidence-rows /runs/h001_first_eval_replacement_pair_objective_v4b_external_candidate_detector_heldout_v1/external_candidate_followup_evidence_v3_explicit_candidates/external_candidate_followup_evidence_rows.jsonl --candidate-artifact /runs/h001_first_eval_replacement_artifacts_spatial_nms_p97_k20_v1/all_scenes_aligned.jsonl --out-root /runs/h001_first_eval_replacement_pair_objective_v4b_external_candidate_detector_heldout_v1/identity_resolution_design_v1 --cluster-radius-m 2.0 --local-score-tolerance 0.002 --outside-score-margin 0.005
variant_summary:
  current_v3_defer:
    commit_rows: 0
    success_commit_rows: 0
...
```text
date_checked: 2026-05-19
implementation: src/h001_runtime/analyze_external_candidate_followup_evidence.py
...
docker_compile_check:
  python -m py_compile src/h001_runtime/analyze_external_candidate_followup_evidence.py
```
...
docker_command:
  docker run --rm --ipc=host --user "$(id -u):$(id -g)" -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPATH=/workspace/src -v /tmp/research3-runs:/runs -v /home/yoohyun/research3:/workspace:ro research3/habitat-h001:20260508-calib-artifacts micromamba run -n base python -m h001_runtime.analyze_external_candidate_followup_evidence --external-evidence-v4-rows /runs/h001_v3_fresh_validation_pair_objective_v4b_external_candidate_detector_v1/external_candidate_evidence_v4/external_candidate_evidence_v4_rows.jsonl --followup-observation-plan /runs/h001_v3_fresh_validation_pair_objective_v4b_external_candidate_detector_v1/external_candidate_followup_plan/external_candidate_followup_observation_plan.jsonl --detector-root /runs/h001_v3_fresh_validation_pair_objective_v4b_external_candidate_detector_v1/external_candidate_followup_detector --object-node-features /runs/h001_v3_fresh_validation_pair_objective_v4_revised_geometry_v1/association_recovery/candidate_object_node_features_after_second.jsonl --candidate-artifact /runs/h001_v3_fresh_validation_artifacts_spatial_nms_p97_k20_v1/all_scenes_aligned.jsonl --out-root /runs/h001_v3_fresh_validation_pair_objective_v4b_external_candidate_detector_v1/external_candidate_followup_evidence_v4_selected_local_cluster_margin --objective-version v4
source_request_rows: 7
action_counts:
  followup_evidence_v1_defer: 1
  followup_evidence_v1_request_identity_confirmation: 6
...
```text
date_checked: 2026-05-19
script: src/h001_runtime/design_selected_wrong_recovery.py
...
```text
date_checked: 2026-05-19
planner_file: src/h001_runtime/plan_external_candidate_second_stage_identity_confirmation.py
...
job_script: scripts/h001_jobs/v4_semantic_neighbor_stage2_validation.sh
primary_command:
  TS=20260519-232655 bash scripts/h001_jobs/v4_semantic_neighbor_stage2_validation.sh
...
primary_log: archive/logs/h001_runtime/v4-semantic-neighbor-stage2-validation-20260519-232655.log
...
cpu_retry_log: archive/logs/h001_runtime/v4-semantic-neighbor-stage2-validation-20260519-232755.log
...
gpu_rerun_log: archive/logs/h001_runtime/v4-semantic-neighbor-stage2-validation-20260520-190626.log
...
code_change:
  planner: src/h001_runtime/plan_external_candidate_second_stage_identity_confirmation.py
  job_wrapper: scripts/h001_jobs/v4_semantic_neighbor_stage2_validation.sh
new_planner_args:
...
log: archive/logs/h001_runtime/v4-semantic-neighbor-multiview-selected-wrong-20260520-235618.log
...
code_change:
  analyzer: src/h001_runtime/analyze_external_candidate_second_stage_identity_evidence.py
  integrated_summary: src/h001_runtime/summarize_followup_v2_stage2.py
...
log: archive/logs/h001_runtime/v4-semantic-neighbor-v3-full-20260521-004207.log
...
date_checked: 2026-05-21
code_change:
  followup_analyzer: src/h001_runtime/analyze_external_candidate_followup_evidence.py
  integrated_summary: src/h001_runtime/summarize_followup_v2_stage2.py
  job_wrapper: scripts/h001_jobs/v4_semantic_neighbor_stage2_validation.sh
...
```text
date_checked: 2026-05-21
diagnostic_script: src/h001_runtime/diagnose_heldout_sofa_stage2_failure.py
...
geometry_check_script: src/h001_runtime/check_stage2_projection_geometry.py
...
status: completed
log: archive/logs/h001_runtime/heldout-local-rival-expanded-grounded-retry-20260521-015542.log
...
```text
date_checked: 2026-05-21
design_script: src/h001_runtime/design_broader_retrieval_backend.py
...
```text
date_checked: 2026-05-21
design_script: src/h001_runtime/design_local_context_arbitration.py
...
```text
date_checked: 2026-05-21
probe_script: src/h001_runtime/probe_dense_backend_recall.py
...
long_job_script: scripts/h001_jobs/dense_backend_recall_y9h_chair.sh
...
long_job_log: archive/logs/h001_runtime/dense-backend-recall-y9h-chair-20260521-030146.log
```
...
log: archive/logs/h001_runtime/dense-backend-fixed-detector-y9h-chair-20260521-031417.log
status: completed
detector_rows: 12
...
```text
script: src/h001_runtime/diagnose_detector_association.py
...
```text
script: src/h001_runtime/design_dense_association_repair.py
...
log: archive/logs/h001_runtime/dense-backend-fixed-detector-depth2-y9h-chair-20260521-034718.log
association_depth_tolerance_m: 2.0
status: completed
detector_box_rate: 1.0
sam2_mask_rate: 1.0
...
```text
script: src/h001_runtime/evaluate_dense_repair_commit.py
...
```text
contract: experiments/h001_uncertainty-reobservation/07_evaluation_contract.md
...
```text
date_checked: 2026-05-21
workflow: experiments/h001_uncertainty-reobservation/runtime/workflow-20260521-dense-conflict.md
contract: experiments/h001_uncertainty-reobservation/07_evaluation_contract.md#independent-dense-conflict-validation-contract
...
```text
manifest_builder: src/h001_runtime/build_dense_conflict_manifest.py
recall_gate: src/h001_runtime/probe_dense_conflict_recall.py
dense_artifact_job: scripts/h001_jobs/dense_conflict_candidate_artifact.sh
scene_specs: configs/h001/manifests/dense_conflict_v1_scenes.txt
...
```text
1. create configs/h001/manifests/h001_dense_conflict_v1.json from the frozen row list [done]
