...
`rival_contradiction_region_contamination_multi_case_path_closure_v1` is statically verified at `configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_path_closure_v1.json` / `.verify.json`.
...
`next_label_free_branch_after_rival_contradiction_closure_v1` is statically verified at `configs/h001/manifests/h001_next_label_free_branch_after_rival_contradiction_closure_v1.json` / `.verify.json`.
...
`goal_region_object_relation_coverage_completion_v1` is statically verified at `configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_v1.json` / `.verify.json`.
...
`goal_region_object_relation_coverage_completion_v1` materializer is Docker-verified with script `src/h001_runtime/materialize_goal_region_object_relation_coverage_completion.py`.
...
`goal_region_object_relation_coverage_completion_frame_projection_v1` is statically verified at `configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_frame_projection_v1.json` / `.verify.json`.
...
`goal_region_object_relation_coverage_completion_frame_projection_v1` is Docker-verified with planner `src/h001_runtime/plan_goal_region_object_relation_coverage_completion_frame_projection.py` and job `scripts/h001_jobs/goal_region_object_relation_coverage_completion_frame_projection.sh`.
...
`goal_region_object_relation_coverage_completion_detector_substrate_v1` is statically verified at `configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_detector_substrate_v1.json` / `.verify.json`.
...
`goal_region_object_relation_coverage_completion_detector_substrate_v1` is Docker-verified with wrapper `scripts/h001_jobs/goal_region_object_relation_coverage_completion_detector_substrate.sh`.
...
`goal_region_object_relation_coverage_completion_detector_evidence_v1` is statically verified at `configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_detector_evidence_v1.json` / `.verify.json`.
...
`goal_region_object_relation_coverage_completion_detector_evidence_v1` is Docker-verified with materializer `src/h001_runtime/materialize_goal_region_object_relation_coverage_completion_detector_evidence.py`.
...
`goal_region_object_relation_coverage_completion_evaluation_join_v1` is frozen and Docker-verified with materializer `src/h001_runtime/materialize_goal_region_object_relation_coverage_completion_evaluation_join.py`.
...
`goal_region_object_relation_coverage_completion_promotion_gate_v1` is frozen and Docker-verified with materializer `src/h001_runtime/run_goal_region_object_relation_coverage_completion_promotion_gate.py`.
...
`goal_region_object_relation_coverage_completion_path_closure_v1` is statically verified at `configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_path_closure_v1.json` / `.verify.json`.
...
`next_label_free_branch_after_coverage_completion_closure_v1` is statically verified at `configs/h001/manifests/h001_next_label_free_branch_after_coverage_completion_closure_v1.json` / `.verify.json`.
...
`fully_covered_goal_validity_failure_v1` is frozen and statically verified at `configs/h001/manifests/h001_fully_covered_goal_validity_failure_v1.json` / `.verify.json`.
...
`fully_covered_goal_validity_failure_v1` diagnostic materializer is Docker-verified with script `src/h001_runtime/materialize_fully_covered_goal_validity_failure.py`.
...
`fully_covered_goal_validity_failure_asymmetry_inspection_v1` is Docker-verified with script `src/h001_runtime/inspect_fully_covered_goal_validity_failure_asymmetry.py`.
...
`fully_covered_candidate_conditioned_contrast_v1` is statically verified at `configs/h001/manifests/h001_fully_covered_candidate_conditioned_contrast_v1.json` / `.verify.json`.
...
`fully_covered_candidate_conditioned_contrast_v1` materializer is Docker-verified with script `src/h001_runtime/materialize_fully_covered_candidate_conditioned_contrast.py`.
...
```text
configs/h001/manifests/h001_rival_identity_strict_arbitration_v1.json
```
...
```text
src/h001_runtime/analyze_rival_identity_post_observation.py
```
...
log: archive/logs/h001_runtime/rival-identity-goal-validity-independent-detector-20260527-021807.log
...
router_script: src/h001_runtime/route_goal_validity_revision_v2.py
...
```text
contract: configs/h001/manifests/h001_discriminative_rival_view_planner_v1.json
...
```text
planner_script: src/h001_runtime/plan_discriminative_rival_view.py
...
log: archive/logs/h001_runtime/discriminative-rival-view-detector-20260527-032810.log
expected_files:
...
```bash
cd /home/yoohyun/research3 && TS=20260527-032810 ROOT=/home/yoohyun/research3 PLAN_OUT=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_plan_v2 FRAMES=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_frames_v2/nonblank_filter_v1/rival_identity_frame_summary_nonblank.jsonl FRAME_ROOT=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_frames_v2 FRAME_EXPORT_SUMMARY=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_frames_v2/summary.json CANDIDATE_ARTIFACT=/home/yoohyun/research3/local_dataset/runs/h001_rival_identity_goal_validity_independent_plan_standoff_navmesh_v1/rival_identity_candidate_artifact.jsonl OUT=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_detector_substrate_v1 EXPECTED_FRAME_ROWS=38 MAX_FRAMES=38 MAX_DEBUG_IMAGES=180 LOG=/home/yoohyun/research3/archive/logs/h001_runtime/discriminative-rival-view-detector-20260527-032810.log STATUS=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_detector_substrate_v1/job_status.json bash /home/yoohyun/research3/scripts/h001_jobs/rival_identity_pair_probe_detector_substrate.sh
```
...
v2_log: archive/logs/h001_runtime/discriminative-rival-view-detector-v2-20260527-033307.log
...
```bash
cd /home/yoohyun/research3 && TS=20260527-033307 ROOT=/home/yoohyun/research3 PLAN_OUT=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_plan_v2 FRAMES=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_frames_v2/nonblank_filter_v1/rival_identity_frame_summary_nonblank.jsonl FRAME_ROOT=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_frames_v2 FRAME_EXPORT_SUMMARY=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_frames_v2/summary.json CANDIDATE_ARTIFACT=/home/yoohyun/research3/local_dataset/runs/h001_rival_identity_goal_validity_independent_plan_standoff_navmesh_v1/rival_identity_candidate_artifact.jsonl OUT=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_detector_substrate_v2 EXPECTED_FRAME_ROWS=38 MAX_FRAMES=38 MAX_DEBUG_IMAGES=180 LOG=/home/yoohyun/research3/archive/logs/h001_runtime/discriminative-rival-view-detector-v2-20260527-033307.log STATUS=/home/yoohyun/research3/local_dataset/runs/h001_discriminative_rival_view_detector_substrate_v2/job_status.json bash /home/yoohyun/research3/scripts/h001_jobs/rival_identity_pair_probe_detector_substrate.sh
```
...
```text
script: src/h001_runtime/analyze_discriminative_rival_view_evidence.py
...
```text
script: src/h001_runtime/diagnose_discriminative_rival_view_failure.py
...
```text
contract: configs/h001/manifests/h001_expanded_retrieval_branch_v1.json
...
```text
planner: src/h001_runtime/plan_expanded_retrieval_branch.py
...
```text
script: src/h001_runtime/design_expanded_retrieval_candidate_set_guard.py
...
```text
script: src/h001_runtime/analyze_expanded_retrieval_guard_proxy_features.py
...
```text
script: src/h001_runtime/analyze_expanded_retrieval_source_pool_validity_proxy.py
...
```text
contract: configs/h001/manifests/h001_expanded_retrieval_detector_evidence_v1.json
planner: src/h001_runtime/plan_expanded_retrieval_detector_observation.py
...
viewpoint_revision_contract: configs/h001/manifests/h001_expanded_retrieval_detector_viewpoint_revision_v1.json
...
fixed_anchor_detector_rerun_job:
  ...
  log: archive/logs/h001_runtime/expanded-retrieval-detector-anchor-20260527-163608.log
  ...
  launch_command: >-
    ...
    LOG=/home/yoohyun/research3/archive/logs/h001_runtime/expanded-retrieval-detector-anchor-20260527-163608.log
    ...
    bash /home/yoohyun/research3/scripts/h001_jobs/expanded_retrieval_detector_substrate.sh
  verification_command: >-
...
```text
fresh_source_manifest: configs/h001/manifests/h001_expanded_retrieval_fresh_validation_v1.json
...
ambiguity_contract: configs/h001/manifests/h001_expanded_retrieval_ambiguity_objective_v1.json
...
```text
paper_scale_manifest: configs/h001/manifests/h001_expanded_retrieval_paper_scale_v1.json
...
log: archive/logs/h001_runtime/paper-scale-expanded-retrieval-detector-substrate-upper-20260527-194607.log
...
contract: configs/h001/manifests/h001_expanded_retrieval_local_context_disambiguation_v1.json
...
docker run --rm --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.plan_expanded_retrieval_local_context_disambiguation \
    --contract /workspace/configs/h001/manifests/h001_expanded_retrieval_local_context_disambiguation_v1.json \
...
log: archive/logs/h001_runtime/paper-scale-local-context-detector-substrate-20260527-205216.log
...
tmux new-session -d -s h001-paper-local-context-detector-${TS} \
  ...
  HYP=/home/yoohyun/research3/experiments/h001_uncertainty-reobservation \
  ...
  LOG=/home/yoohyun/research3/archive/logs/h001_runtime/paper-scale-local-context-detector-substrate-20260527-205216.log \
...
```text
script: src/h001_runtime/analyze_expanded_retrieval_local_context_evidence.py
...
```text
script: src/h001_runtime/diagnose_expanded_retrieval_local_context_failures.py
...
docker run --rm --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.analyze_expanded_retrieval_local_context_revision \
    --contract /workspace/configs/h001/manifests/h001_expanded_retrieval_local_context_revision_v1.json \
    --plan /runs/h001_expanded_retrieval_paper_scale_local_context_plan_v1/expanded_retrieval_local_context_plan.jsonl \
    --detector-associations /runs/h001_expanded_retrieval_paper_scale_local_context_detector_substrate_v1/expanded_retrieval_detector_associations.jsonl \
    --detector-summary /runs/h001_expanded_retrieval_paper_scale_local_context_detector_substrate_v1/detector_v3c/summary.json \
...
docker run --rm --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.analyze_expanded_retrieval_local_context_route_specific \
    --contract /workspace/configs/h001/manifests/h001_expanded_retrieval_local_context_route_contract_v1.json \
    --evidence-rows /runs/h001_expanded_retrieval_paper_scale_local_context_revision_v1/expanded_retrieval_local_context_revision_evidence_rows.jsonl \
    --decision-rows /runs/h001_expanded_retrieval_paper_scale_local_context_revision_v1/expanded_retrieval_local_context_revision_decision_rows.jsonl \
    --evaluated-rows /runs/h001_expanded_retrieval_paper_scale_local_context_revision_v1/expanded_retrieval_local_context_revision_evaluated_rows.jsonl \
    --evaluation-labels /runs/h001_rival_identity_goal_validity_independent_source_v1/rival_identity_goal_validity_independent_evaluation_labels.jsonl \
...
docker run --rm --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.analyze_expanded_retrieval_backend_candidate_generation \
    --contract /workspace/configs/h001/manifests/h001_expanded_retrieval_backend_candidate_generation_v1.json \
...
```text
script: src/h001_runtime/analyze_expanded_retrieval_deeper_backend_generation.py
...
```text
script: src/h001_runtime/analyze_expanded_retrieval_goal_validity_confirmation.py
...
```text
script: src/h001_runtime/analyze_expanded_retrieval_pool_validity_branch.py
...
log: archive/logs/h001_runtime/expanded-retrieval-pool-validity-branch-20260529-093033.log
...
```text
script: src/h001_runtime/analyze_expanded_retrieval_pool_validity_second_fallback.py
...
current_status: completed
current_stage: completed
log: archive/logs/h001_runtime/expanded-retrieval-pool-validity-second-fallback-20260529-151217.log
...
```text
configs/h001/manifests/h001_expanded_retrieval_goal_validity_evidence_v1.json
```
...
script: scripts/h001_jobs/expanded_retrieval_detector_substrate.sh
...
log: archive/logs/h001_runtime/goal-validity-evidence-detector-substrate-20260529-171217.log
...
tmux new-session -d -s "h001-goal-validity-full-detector-${ts}" \
  "cd /home/yoohyun/research3 && \
   ...
   MIN_CANDIDATE_ASSOCIATION_RATE=0.40 \
   MAX_DEBUG_IMAGES=180 \
   LOG=/home/yoohyun/research3/archive/logs/h001_runtime/goal-validity-full-detector-${ts}.log \
...
tmux new-session -d -s "h001-goal-validity-full-substrate-${ts}" \
  "cd /home/yoohyun/research3 && TS=${ts} bash scripts/h001_jobs/expanded_retrieval_goal_validity_full_substrate.sh"
```

Launch record:

```text
wrapper: scripts/h001_jobs/expanded_retrieval_goal_validity_full_substrate.sh
session: h001-goal-validity-full-substrate-20260529-202640
working_directory: /home/yoohyun/research3
log: archive/logs/h001_runtime/goal-validity-full-substrate-20260529-202640.log
...
blocked_actions:
  ...
  first_eval_rerun
next_script_target: src/h001_runtime/diagnose_expanded_retrieval_goal_validity_ambiguity.py
...
next_script_target: src/h001_runtime/analyze_expanded_retrieval_goal_validity_discriminative_evidence.py
...
docker_image: research3/habitat-h001:20260508-calib-artifacts
planner_script: src/h001_runtime/plan_expanded_retrieval_goal_validity_object_relation_observation.py
...
frame_export_command: /opt/conda/bin/python src/h001_runtime/export_postview_frames_v2.py
nonblank_filter_command: /opt/conda/bin/python src/h001_runtime/filter_nonblank_frame_summary.py
projection_smoke_command: /opt/conda/bin/python src/h001_runtime/smoke_expanded_retrieval_projection_anchor.py
expected_files:
...
script: scripts/h001_jobs/expanded_retrieval_goal_validity_object_relation_fresh_detector_substrate.sh
...
launch_command: TS=20260531-013027 bash scripts/h001_jobs/expanded_retrieval_goal_validity_object_relation_fresh_detector_substrate.sh
uses_gt_for_action: false
paper_claim_allowed: false
...
working_directory: /home/yoohyun/research3
command: TS=20260531-174311 bash scripts/h001_jobs/expanded_retrieval_goal_validity_unique_support_goal_region_detector_substrate.sh
wrapper: scripts/h001_jobs/expanded_retrieval_goal_validity_unique_support_goal_region_detector_substrate.sh
base_wrapper: scripts/h001_jobs/expanded_retrieval_detector_substrate.sh
...
에이전트 추론: The next workflow step is `src/h001_runtime/diagnose_expanded_retrieval_goal_validity_partial_relation_depth_association_geometry_repair.py`. It should account for both underlink requests and emit nonterminal repair/re-observation/defer rows without label joins.
...
```text
src/h001_runtime/build_dense_conflict_manifest.py
src/h001_runtime/probe_dense_conflict_recall.py
src/h001_runtime/analyze_dense_conflict_validation.py
src/h001_runtime/design_dense_conflict_generalization.py
scripts/h001_jobs/dense_conflict_candidate_artifact.sh
scripts/h001_jobs/dense_conflict_validation_from_source.sh
configs/h001/manifests/h001_dense_conflict_v1.json
configs/h001/manifests/h001_dense_conflict_v1.verify.json
configs/h001/manifests/dense_conflict_v1_scenes.txt
```
...
script: scripts/h001_jobs/dense_conflict_candidate_artifact.sh
log: archive/logs/h001_runtime/dense-conflict-artifact-p95-k100-d10-20260521-175656.log
...
tmux new-session -d -s "h001-dense-conflict-artifact-${ts}" \
  "cd /home/yoohyun/research3 && TS=${ts} bash scripts/h001_jobs/dense_conflict_candidate_artifact.sh"
```
...
working_directory: /home/yoohyun/research3
command: TS=20260523-140845 DATA_ROOT=/home/yoohyun/research3/local_dataset/data RUNS_ROOT=/home/yoohyun/research3/local_dataset/runs MODEL_ROOT=/home/yoohyun/research3/local_dataset/models bash scripts/h001_jobs/dense_conflict_candidate_artifact.sh
log: archive/logs/h001_runtime/dense-conflict-artifact-p95-k100-d10-20260523-140845.log
...
script: src/h001_runtime/analyze_dense_conflict_validation.py
wrapper: scripts/h001_jobs/dense_conflict_validation_from_source.sh
```
...
```text
script: src/h001_runtime/build_dense_conflict_generalization_manifest.py
...
source_manifest: configs/h001/manifests/h001_first_eval_replacement_v1.json
...
log: archive/logs/h001_runtime/dense-conflict-generalization-detector-substrate-20260523-170533.log
status: completed
...
```text
script: src/h001_runtime/design_dense_conflict_terminal_guard.py
...
guard_config: configs/h001/manifests/h001_dense_conflict_terminal_guard_v1.json
...
```text
script: src/h001_runtime/diagnose_dense_conflict_terminal_failures.py
...
```text
script: src/h001_runtime/analyze_dense_conflict_rival_identity_policy.py
...
```text
manifest: configs/h001/manifests/h001_rival_identity_observation_v1.json
...
docker run --rm --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.plan_rival_identity_observation \
    --contract /workspace/configs/h001/manifests/h001_rival_identity_observation_v1.json \
    --runs-root /runs \
...
log_template: archive/logs/h001_runtime/rival-identity-detector-substrate-<timestamp>.log
...
tmux new-session -d -s h001-rival-identity-detector-${ts} \
  "cd /home/yoohyun/research3 && TS=${ts} bash scripts/h001_jobs/rival_identity_pair_probe_detector_substrate.sh"
```
...
command: TS=20260526-012036 bash scripts/h001_jobs/rival_identity_pair_probe_detector_substrate.sh
status_file: local_dataset/runs/h001_rival_identity_pair_probe_detector_substrate_v1/job_status.json
status_at_launch_check: running
stage_at_launch_check: detector_mask_scoring
log: archive/logs/h001_runtime/rival-identity-detector-substrate-20260526-012036.log
...
docker run --rm --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.analyze_dense_conflict_rival_identity_policy \
    --guard-config /workspace/configs/h001/manifests/h001_dense_conflict_terminal_guard_v1.json \
...
docker run --rm --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.build_rival_identity_generalization_manifest \
    ...
    --guard-config /workspace/configs/h001/manifests/h001_dense_conflict_terminal_guard_v1.json \
    --out-manifest /workspace/configs/h001/manifests/h001_rival_identity_generalization_v1.json \
    --verify-out /workspace/configs/h001/manifests/h001_rival_identity_generalization_v1.verify.json \
...
docker run --rm --ipc=host \
  ...
  research3/habitat-h001:20260508-calib-artifacts \
  micromamba run -n base python -m h001_runtime.plan_rival_identity_observation \
    --contract /workspace/configs/h001/manifests/h001_rival_identity_generalization_v1.json \
    --runs-root /runs \
    --workspace-root /workspace \
...
tmux new-session -d -s h001-rival-identity-generalization-detector-${TS} \
  ...
  MAX_FRAMES=12 \
  LOG=/home/yoohyun/research3/archive/logs/h001_runtime/rival-identity-generalization-detector-substrate-${TS}.log \
  ...
  bash scripts/h001_jobs/rival_identity_pair_probe_detector_substrate.sh"
```
...
```text
wrapper: scripts/h001_jobs/rival_identity_pair_probe_detector_substrate.sh
code_update: src/h001_runtime/detect_postview_groundingdino_sam2.py now accepts --frame-root
working_directory: /home/yoohyun/research3
...
log: archive/logs/h001_runtime/rival-identity-broader-detector-substrate-v2-20260526-235709.log
detector_rows: 112
detector_box_rate: 1.0
sam2_mask_rate: 1.0
...
```text
script: src/h001_runtime/diagnose_broader_post_observation_failure.py
...
log: archive/logs/h001_runtime/rival-identity-broader-standoff-navmesh-detector-20260527-011137.log
...
- Contract: `configs/h001/manifests/h001_expanded_retrieval_goal_validity_partial_relation_depth_association_geometry_repair_v1.json`
- Script: `src/h001_runtime/diagnose_expanded_retrieval_goal_validity_partial_relation_depth_association_geometry_repair.py`
- Docker image: `research3/openvocab-perception:20260513-v3c-gdino-sam2`
...
The follow-up repair contract is frozen at `configs/h001/manifests/h001_expanded_retrieval_goal_validity_partial_relation_depth_association_geometry_followup_repair_v1.json`.
...
The router is now implemented at `src/h001_runtime/route_expanded_retrieval_goal_validity_partial_relation_depth_association_geometry_followup_repair.py` and Docker-run at `local_dataset/runs/h001_expanded_retrieval_goal_validity_partial_relation_depth_association_geometry_followup_repair_v1`.
...
The relation-anchor selection repair probe contract is frozen at `configs/h001/manifests/h001_relation_anchor_selection_repair_v1.json`.
...
The probe is now implemented at `src/h001_runtime/probe_relation_anchor_selection_repair.py` and Docker-run at `local_dataset/runs/h001_relation_anchor_selection_repair_v1`.
...
The direction-specific re-observation repair probe contract is frozen at `configs/h001/manifests/h001_direction_specific_reobservation_repair_v1.json`.
...
The direction-specific re-observation repair probe is now implemented at `src/h001_runtime/probe_direction_specific_reobservation_repair.py` and Docker-run at `local_dataset/runs/h001_direction_specific_reobservation_repair_v1`.
...
The repeated-object relation-anchor ambiguity branch contract is frozen at `configs/h001/manifests/h001_repeated_object_relation_anchor_ambiguity_v1.json`; static source verification is recorded in `configs/h001/manifests/h001_repeated_object_relation_anchor_ambiguity_v1.verify.json`.
...
The repeated-object relation-anchor ambiguity branch is now implemented at `src/h001_runtime/route_repeated_object_relation_anchor_ambiguity.py` and Docker-run at `local_dataset/runs/h001_repeated_object_relation_anchor_ambiguity_v1`.
...
The depth-stagnation branch contract is frozen at `configs/h001/manifests/h001_depth_stagnation_branch_v1.json`; static source verification is recorded in `configs/h001/manifests/h001_depth_stagnation_branch_v1.verify.json`.
...
The depth-stagnation branch is now implemented at `src/h001_runtime/route_depth_stagnation_branch.py` and Docker-run at `local_dataset/runs/h001_depth_stagnation_branch_v1`.
...
The residual branch synthesis contract is frozen at `configs/h001/manifests/h001_residual_partial_relation_depth_branch_synthesis_v1.json`; Docker verification is recorded in `configs/h001/manifests/h001_residual_partial_relation_depth_branch_synthesis_v1.verify.json`.
...
The residual branch promotion requirement contract is frozen at `configs/h001/manifests/h001_residual_branch_promotion_requirement_v1.json`; Docker verification is recorded in `configs/h001/manifests/h001_residual_branch_promotion_requirement_v1.verify.json`.
...
The repeated-object relation-anchor consistency evidence contract is frozen at `configs/h001/manifests/h001_repeated_object_relation_anchor_consistency_evidence_v1.json`; static source verification is recorded in `configs/h001/manifests/h001_repeated_object_relation_anchor_consistency_evidence_v1.verify.json`.
...
```text
implementation: src/h001_runtime/analyze_repeated_object_relation_anchor_consistency_evidence.py
verify: configs/h001/manifests/h001_repeated_object_relation_anchor_consistency_detector_evidence_v1.verify.json
...
```text
implementation: src/h001_runtime/diagnose_repeated_object_relation_anchor_consistency_residual.py
...
```text
implementation: src/h001_runtime/analyze_association_geometry_underlink_repair_followup_evidence.py
verify: configs/h001/manifests/h001_association_geometry_underlink_repair_followup_evidence_v1.verify.json
...
에이전트 추론: The closure contract chooses residual branch family closure over a one-row depth-stagnation independent-support probe. The reason is reviewer-defense rather than convenience: repeated-object and association-geometry branches already failed promotion after extra evidence, and the only depth-stagnation row repeats stagnant association/depth counts. The next workflow step is to implement `src/h001_runtime/close_residual_partial_relation_depth_branches.py` so closure rows explicitly record each residual family as terminal-blocking evidence. Terminal utility, candidate commit/rejection, `first_eval`, policy-scale comparison, and paper claims remain blocked.
...
```text
implementation: src/h001_runtime/close_residual_partial_relation_depth_branches.py
verify: configs/h001/manifests/h001_residual_branch_closure_v1.verify.json
...
implementation: src/h001_runtime/select_next_label_free_evidence_family.py
...
RGB / depth / pose / metadata files: 1012 / 1012 / 1012 / 1012
next implementation target: src/h001_runtime/audit_semantic_slam_map_pose_consistency_sources.py
...
implementation target: src/h001_runtime/compare_semantic_slam_proxy_policies.py
...
```text
implementation: src/h001_runtime/evaluate_semantic_slam_proxy_comparison_output.py
verify: configs/h001/manifests/h001_semantic_slam_proxy_comparison_output_evaluation_v1.verify.json
docker image: research3/openvocab-perception:20260513-v3c-gdino-sam2
...
```text
contract: configs/h001/manifests/h001_semantic_slam_non_dominated_proxy_redesign_v1.json
verify: configs/h001/manifests/h001_semantic_slam_non_dominated_proxy_redesign_v1.verify.json
...
policy-scale comparison allowed: false
paper_claim_allowed: false
next implementation: src/h001_runtime/compare_semantic_slam_non_dominated_proxy.py
```
...
```text
implementation: src/h001_runtime/compare_semantic_slam_non_dominated_proxy.py
verify: configs/h001/manifests/h001_semantic_slam_non_dominated_proxy_redesign_v1.verify.json
docker image: research3/openvocab-perception:20260513-v3c-gdino-sam2
...
future implementation: src/h001_runtime/compare_semantic_slam_reviewer_defense_proxy.py
...
```bash
docker run --rm --ipc=host -v "$PWD":/workspace -w /workspace -e PYTHONPATH=/workspace/src research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m compileall src/h001_runtime/materialize_semantic_slam_task_policy_selector.py
docker run --rm --ipc=host -v "$PWD":/workspace -w /workspace -e PYTHONPATH=/workspace/src research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m h001_runtime.materialize_semantic_slam_task_policy_selector
```
...
```bash
jq empty configs/h001/manifests/h001_semantic_slam_candidate_map_pose_selector_v1.json
jq empty configs/h001/manifests/h001_semantic_slam_candidate_map_pose_selector_v1.verify.json
```
...
```bash
docker run --rm --ipc=host -v "$PWD":/workspace -w /workspace -e PYTHONPATH=/workspace/src research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m compileall src/h001_runtime/materialize_semantic_slam_candidate_map_pose_selector.py
docker run --rm --ipc=host -v "$PWD":/workspace -w /workspace -e PYTHONPATH=/workspace/src research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m h001_runtime.materialize_semantic_slam_candidate_map_pose_selector
```
...
```bash
jq empty configs/h001/manifests/h001_semantic_slam_geometry_only_closure_v1.json
jq empty configs/h001/manifests/h001_semantic_slam_geometry_only_closure_v1.verify.json
```
...
source_frame_projection_verify: configs/h001/manifests/h001_rival_contradiction_region_contamination_frame_projection_v1.verify.json
...
```text
date_checked: 2026-06-12
detector_substrate_verify: configs/h001/manifests/h001_rival_contradiction_region_contamination_detector_substrate_v1.verify.json
detector_evidence_verify: configs/h001/manifests/h001_rival_contradiction_region_contamination_detector_evidence_v1.verify.json
evaluation_join_verify: configs/h001/manifests/h001_rival_contradiction_region_contamination_detector_evaluation_join_v1.verify.json
promotion_gate_verify: configs/h001/manifests/h001_rival_contradiction_region_contamination_detector_promotion_gate_v1.verify.json
...
paper_claim_allowed: false
next_materializer: src/h001_runtime/materialize_rival_contradiction_region_contamination_multi_case_source.py
...
source contracts:
  configs/h001/manifests/h001_semantic_slam_task_map_evidence_v1.json
  configs/h001/manifests/h001_reviewer_defense_baseline_matrix_v1.json
...
implementation script: src/h001_runtime/materialize_semantic_slam_candidate_relative_active_observation_utility.py
...
```bash
jq empty configs/h001/manifests/h001_semantic_slam_candidate_relative_active_observation_utility_v1.json
jq empty configs/h001/manifests/h001_semantic_slam_candidate_relative_active_observation_utility_v1.verify.json
jq '.status, .contract_scope.implementation_allowed_next, .action_space.allowed_actions, .contract_gates' configs/h001/manifests/h001_semantic_slam_candidate_relative_active_observation_utility_v1.json
```
...
```bash
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m py_compile src/h001_runtime/materialize_semantic_slam_candidate_relative_active_observation_utility.py
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m h001_runtime.materialize_semantic_slam_candidate_relative_active_observation_utility
...
```bash
jq empty configs/h001/manifests/h001_semantic_slam_candidate_relative_active_observation_task_proxy_join_v1.json
jq empty configs/h001/manifests/h001_semantic_slam_candidate_relative_active_observation_task_proxy_join_v1.verify.json
jq '.source_gate, .contract_scope, .required_outputs, .contract_gates' configs/h001/manifests/h001_semantic_slam_candidate_relative_active_observation_task_proxy_join_v1.json
```
...
```bash
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m py_compile src/h001_runtime/materialize_semantic_slam_candidate_relative_active_observation_task_proxy_join.py
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m h001_runtime.materialize_semantic_slam_candidate_relative_active_observation_task_proxy_join
...
```bash
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m py_compile src/h001_runtime/analyze_semantic_slam_active_observation_risk.py
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m h001_runtime.analyze_semantic_slam_active_observation_risk
...
implementation target: src/h001_runtime/materialize_semantic_slam_active_observation_post_update.py
...
```bash
jq empty configs/h001/manifests/h001_semantic_slam_active_observation_post_update_v1.json
jq empty configs/h001/manifests/h001_semantic_slam_active_observation_post_update_v1.verify.json
jq '{status, contract_name, source_gate: .source_gate.primary_blocker, gates: .contract_gates, next_task: .next_research_task.task}' configs/h001/manifests/h001_semantic_slam_active_observation_post_update_v1.json
```
...
```bash
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m py_compile src/h001_runtime/materialize_semantic_slam_active_observation_post_update.py
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m h001_runtime.materialize_semantic_slam_active_observation_post_update
...
uses_gt_for_action: false
paper_claim_allowed: false
script: src/h001_runtime/materialize_semantic_slam_candidate_relative_map_pose_evidence.py
...
```bash
jq empty configs/h001/manifests/h001_semantic_slam_candidate_relative_map_pose_evidence_v1.json
jq empty configs/h001/manifests/h001_semantic_slam_candidate_relative_map_pose_evidence_v1.verify.json
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m py_compile src/h001_runtime/materialize_semantic_slam_candidate_relative_map_pose_evidence.py
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m h001_runtime.materialize_semantic_slam_candidate_relative_map_pose_evidence
```
...
```bash
jq empty configs/h001/manifests/h001_semantic_slam_candidate_relative_task_proxy_join_v1.json
jq empty configs/h001/manifests/h001_semantic_slam_candidate_relative_task_proxy_join_v1.verify.json
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m py_compile src/h001_runtime/materialize_semantic_slam_candidate_relative_task_proxy_join.py
docker run --rm --ipc=host --user $(id -u):$(id -g) -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -m h001_runtime.materialize_semantic_slam_candidate_relative_task_proxy_join
...
```bash
jq empty configs/h001/manifests/h001_semantic_slam_candidate_relative_path_closure_v1.json
jq empty configs/h001/manifests/h001_semantic_slam_candidate_relative_path_closure_v1.verify.json
jq '.status, .contract_checks.candidate_relative_top_rule_closed_as_non_promotable, .next_task' configs/h001/manifests/h001_semantic_slam_candidate_relative_path_closure_v1.verify.json
```
