...
이 문서는 H001 실험을 다시 실행하기 위한 데이터, checkpoint, Docker, artifact, evaluation entrypoint를 모은다. 세부 실험 해석은 `experiments/h001_uncertainty-reobservation/04_first_experiment.md`와 `08_runtime_integration.md`를 따른다.
...
- Core runtime package: `src/h001_runtime/`
- Current experiment workspace: `experiments/h001_uncertainty-reobservation/`
- Job wrappers: `scripts/h001_jobs/`
- Helper scripts: `scripts/h001_tools/`
- H001 manifests: `configs/h001/manifests/`
...
- Logs: legacy raw logs are preserved under `archive/logs/` and are not source-of-truth artifacts. New long-running jobs should write timestamped logs under the nearest workflow/experiment `logs/` path or an explicitly documented archive log path.
...
- Current frame/projection contract verify: `configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_frame_projection_v1.verify.json`.
- Previous multi-case detector/SAM2 substrate contract verify: `configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_detector_substrate_v1.verify.json`.
- Current nonterminal report verify: `configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_diagnostic_report_v1.verify.json`.
- Current path closure verify: `configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_path_closure_v1.verify.json`.
- Current branch selection verify: `configs/h001/manifests/h001_next_label_free_branch_after_rival_contradiction_closure_v1.verify.json`.
- Current coverage-completion branch contract verify: `configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_v1.verify.json`.
...
- Current coverage-completion frame/projection contract verify: `configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_frame_projection_v1.verify.json`.
- Current coverage-completion detector/SAM2 substrate contract verify: `configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_detector_substrate_v1.verify.json`.
- Current coverage-completion detector/SAM2 output: `local_dataset/runs/h001_goal_region_object_relation_coverage_completion_detector_substrate_v1`; log `archive/logs/h001_runtime/goal-region-object-relation-coverage-completion-detector-substrate-20260613-232446.log`; status `completed`.
- Current coverage-completion detector evidence contract verify: `configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_detector_evidence_v1.verify.json`.
...
- Current fully covered goal-validity failure contract verify: `configs/h001/manifests/h001_fully_covered_goal_validity_failure_v1.verify.json`.
...
- Current fully covered asymmetry inspection verify: `configs/h001/manifests/h001_fully_covered_goal_validity_failure_asymmetry_inspection_v1.verify.json`.
...
- Current fully covered contrast contract verify: `configs/h001/manifests/h001_fully_covered_candidate_conditioned_contrast_v1.verify.json`.
...
verify: configs/h001/manifests/h001_fully_covered_candidate_conditioned_contrast_v1.verify.json
...
```bash
jq empty configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_frame_projection_v1.json
jq empty configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_frame_projection_v1.verify.json
bash -n scripts/h001_jobs/goal_region_object_relation_coverage_completion_frame_projection.sh
docker run --rm --ipc=host --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -w /workspace research3/habitat-h001:20260508-calib-artifacts /opt/conda/bin/python -B -m py_compile src/h001_runtime/plan_goal_region_object_relation_coverage_completion_frame_projection.py
EXPECTED_FRAME_ROWS=48 scripts/h001_jobs/goal_region_object_relation_coverage_completion_frame_projection.sh
...
```bash
jq empty configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_detector_substrate_v1.json
jq empty configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_detector_substrate_v1.verify.json
jq '{status, ok, next_task, static_contract_checks, future_docker_job}' configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_detector_substrate_v1.verify.json
...
```bash
jq empty configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_detector_evidence_v1.json
jq empty configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_detector_evidence_v1.verify.json
jq '{status, source_verification, static_contract_checks, source_gate_summary, next_task}' configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_detector_evidence_v1.verify.json
```
...
```bash
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m py_compile src/h001_runtime/materialize_goal_region_object_relation_coverage_completion_detector_evidence.py
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m h001_runtime.materialize_goal_region_object_relation_coverage_completion_detector_evidence --out-root /runs/h001_goal_region_object_relation_coverage_completion_detector_evidence_v1
...
```bash
jq empty configs/h001/manifests/h001_fully_covered_goal_validity_failure_v1.json
jq empty configs/h001/manifests/h001_fully_covered_goal_validity_failure_v1.verify.json
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m py_compile src/h001_runtime/materialize_fully_covered_goal_validity_failure.py
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m h001_runtime.materialize_fully_covered_goal_validity_failure --out-root /runs/h001_fully_covered_goal_validity_failure_v1
...
jq '{status, contract_name, target_counts, target_rows, next_research_task}' configs/h001/manifests/h001_fully_covered_goal_validity_failure_v1.json
jq '{status, target_verification, static_contract_checks, next_task}' configs/h001/manifests/h001_fully_covered_goal_validity_failure_v1.verify.json
```
...
```bash
jq empty configs/h001/manifests/h001_fully_covered_goal_validity_failure_asymmetry_inspection_v1.json
jq empty configs/h001/manifests/h001_fully_covered_goal_validity_failure_asymmetry_inspection_v1.verify.json
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m py_compile src/h001_runtime/inspect_fully_covered_goal_validity_failure_asymmetry.py
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m h001_runtime.inspect_fully_covered_goal_validity_failure_asymmetry --out-root /runs/h001_fully_covered_goal_validity_failure_asymmetry_inspection_v1
...
```bash
jq empty configs/h001/manifests/h001_fully_covered_candidate_conditioned_contrast_v1.json
jq empty configs/h001/manifests/h001_fully_covered_candidate_conditioned_contrast_v1.verify.json
...
```bash
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m py_compile src/h001_runtime/materialize_fully_covered_candidate_conditioned_contrast.py
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m h001_runtime.materialize_fully_covered_candidate_conditioned_contrast --out-root /runs/h001_fully_covered_candidate_conditioned_contrast_v1
...
```text
contract status: static_verified_multi_case_detector_sam2_substrate_contract_frozen_terminal_blocked
source frame rows: 72
source nonblank rows: 72
source projection visible rows: 72/72
candidate tuple coverage: 26/26
docker image: research3/openvocab-perception:20260513-v3c-gdino-sam2
expected detector rows: 72
min detector box/SAM2/candidate association: 0.8 / 0.8 / 0.4
min rows with candidate association: 29
min associated candidate heading count: 36
...
```bash
bash -n scripts/h001_jobs/rival_contradiction_region_contamination_multi_case_detector_substrate.sh
TS=20260613-014521 ROOT=/home/yoohyun/research3 scripts/h001_jobs/rival_contradiction_region_contamination_multi_case_detector_substrate.sh
cat local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_detector_substrate_v1/job_status.json
cat local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_detector_substrate_v1/expanded_retrieval_detector_substrate_summary.json
cat local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_detector_substrate_v1/rival_contradiction_region_contamination_multi_case_detector_substrate_diagnostic.json
```

Expected output files:

```text
local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_detector_substrate_v1/job_status.json
local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_detector_substrate_v1/detector_v3c/summary.json
local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_detector_substrate_v1/expanded_retrieval_detector_associations.jsonl
local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_detector_substrate_v1/expanded_retrieval_detector_frame_summary.jsonl
local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_detector_substrate_v1/expanded_retrieval_detector_substrate_summary.json
local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_detector_substrate_v1/rival_contradiction_region_contamination_multi_case_detector_substrate_diagnostic.json
```

Detector/SAM2 result summary:
...
role association rows: 17 / 18 / 12 / 17
associated scene/query count: 9 / 5
multi-case detector substrate gate: true
```

Current evidence analyzer contract verification:

```bash
jq empty configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_detector_evidence_v1.json
jq empty configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_detector_evidence_v1.verify.json
jq '{status, ok, next_task, source_verification, static_contract_checks}' configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_detector_evidence_v1.verify.json
```

Evidence materializer reproduction:

```bash
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m py_compile src/h001_runtime/materialize_rival_contradiction_region_contamination_multi_case_detector_evidence.py
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m h001_runtime.materialize_rival_contradiction_region_contamination_multi_case_detector_evidence --out-root /runs/h001_rival_contradiction_region_contamination_multi_case_detector_evidence_v1
jq '{gate, candidate_view_rows, role_rows, pair_rows, request_rows, audit_rows, pair_evidence_state_counts, request_evidence_state_counts, terminal_commit_rows, candidate_commit_rows, candidate_rejection_rows, action_evidence_forbidden_keys_found, uses_gt_for_action, paper_claim_allowed, next_task}' local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_detector_evidence_v1/rival_contradiction_region_contamination_multi_case_detector_evidence_summary.json
```

Evaluation-only join and bounded promotion reproduction:

```bash
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m h001_runtime.materialize_rival_contradiction_region_contamination_multi_case_evaluation_join --out-root /runs/h001_rival_contradiction_region_contamination_multi_case_evaluation_join_v1
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace:ro -v /home/yoohyun/research3/local_dataset/runs:/runs -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m h001_runtime.run_rival_contradiction_region_contamination_multi_case_promotion_gate --out-root /runs/h001_rival_contradiction_region_contamination_multi_case_promotion_gate_v1
jq '{promotion_gate_passed, promotion_gate_blockers, allowed_after_pass, source_pair_rows, contamination_or_contradiction_pair_rows, wrong_labeled_pair_rows, wrong_labeled_pair_rows_with_contamination_or_contradiction_evidence, total_wrong_goal_baseline_rows, max_wasted_path_exposure_m, slam_map_pose_delta_rows, slam_map_pose_delta_maximum, terminal_selector_allowed_after_pass, policy_scale_claim_allowed_after_pass, paper_claim_allowed_after_pass, next_task}' local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_promotion_gate_v1/rival_contradiction_region_contamination_multi_case_promotion_gate_summary.json
```

Nonterminal diagnostic report reproduction:

```bash
jq empty configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_diagnostic_report_v1.json
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m py_compile src/h001_runtime/materialize_rival_contradiction_region_contamination_multi_case_diagnostic_report.py
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m h001_runtime.materialize_rival_contradiction_region_contamination_multi_case_diagnostic_report
jq '{gate, facts, evaluation_only_diagnostics, allowed_next_steps_after_report}' local_dataset/runs/h001_rival_contradiction_region_contamination_multi_case_diagnostic_report_v1/rival_contradiction_region_contamination_multi_case_diagnostic_report_summary.json
jq empty configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_diagnostic_report_v1.verify.json
```
...
blockers: []
source pair rows: 18
observation/frame/projection rows: 72/72/72
...
Diagnostic-only path closure verification:

```bash
jq empty configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_path_closure_v1.json
jq empty configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_path_closure_v1.verify.json
jq '{status, closure_decision, surviving_evidence_role, minimum_future_terminal_contract_requirements, next_research_task}' configs/h001/manifests/h001_rival_contradiction_region_contamination_multi_case_path_closure_v1.json
```
...
terminal utility from current path: blocked
candidate rejection from current path: blocked
evaluation-only fields as action inputs: blocked
next task: select_next_label_free_terminal_or_observation_branch_after_rival_contradiction_closure
```

Next branch selection verification:

```bash
jq empty configs/h001/manifests/h001_next_label_free_branch_after_rival_contradiction_closure_v1.json
jq empty configs/h001/manifests/h001_next_label_free_branch_after_rival_contradiction_closure_v1.verify.json
jq '{status, selected_branch, next_research_task, checks:.contract_checks}' configs/h001/manifests/h001_next_label_free_branch_after_rival_contradiction_closure_v1.json
```
...
target failure: dual_evidence_coverage_gap / goal_region_and_object_relation_both_missing
target rows: 12 pair rows across 7 scenes and 3 queries
implementation allowed now: false
next task: freeze_goal_region_object_relation_coverage_completion_contract
```

Coverage-completion branch contract verification:

```bash
jq empty configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_v1.json
jq empty configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_v1.verify.json
jq '{status, target_counts, observation_contract, next_research_task}' configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_v1.json
```
...
target failure: dual_evidence_coverage_gap / goal_region_and_object_relation_both_missing
target rows: 12 pair/request rows across 7 scenes and 3 queries
...
Coverage-completion materializer reproduction:

```bash
docker run --rm --ipc=host --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m py_compile src/h001_runtime/materialize_goal_region_object_relation_coverage_completion.py
docker run --rm --ipc=host --user $(id -u):$(id -g) -e HOME=/tmp -e PYTHONDONTWRITEBYTECODE=1 -e PYTHONPYCACHEPREFIX=/tmp/pycache -e PYTHONPATH=/workspace/src -v /home/yoohyun/research3:/workspace -w /workspace research3/openvocab-perception:20260513-v3c-gdino-sam2 python -B -m h001_runtime.materialize_goal_region_object_relation_coverage_completion
jq '{status, target_pair_rows, candidate_rows, observation_seed_rows, audit_rows, scene_count, query_count, action_evidence_forbidden_key_count, terminal_commit_rows, candidate_commit_rows, candidate_rejection_rows, uses_gt_for_action_true_rows, paper_claim_allowed_true_rows, materializer_gate_passed, primary_blocker, next_task}' local_dataset/runs/h001_goal_region_object_relation_coverage_completion_v1/goal_region_object_relation_coverage_completion_summary.json
```
...
Coverage-completion frame/projection contract verification:

```bash
jq empty configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_frame_projection_v1.json
jq empty configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_frame_projection_v1.verify.json
jq '{status, source_gate, implementation_target, next_research_task}' configs/h001/manifests/h001_goal_region_object_relation_coverage_completion_frame_projection_v1.json
```
...
docs/index.md
experiments/h001_uncertainty-reobservation/07_evaluation_contract.md
experiments/h001_uncertainty-reobservation/08_runtime_integration.md
configs/h001/manifests/h001_splits_v1.json
configs/docker/Dockerfile.habitat-h001
src/h001_runtime/diagnose_dense_terminal_arbitration.py
scripts/h001_jobs/dense_backend_recall_y9h_chair.sh
```
...
- `archive/logs/h001_runtime/*.log`는 로컬 실행 로그로 취급하고 `.gitignore`에서 제외한다. 재현 필수 정보는 log가 아니라 이 문서와 각 workflow 문서의 command/result summary에 기록한다.
...
Log: archive/logs/h001_runtime/local-dataset-migration-20260521-053204.log
...
- `export/` cache는 `scripts/h001_jobs/dense_backend_recall_y9h_chair.sh`를 다시 실행해 재생성한다.
...
6. Regenerate artifacts and evaluations using the job scripts in `Reproduction Commands` and the current `TODO.md`. Current blocker is multi-case validation for `candidate_conditioned_visible_without_depth_association_blocker` after the Docker-verified `fully_covered_candidate_conditioned_contrast_v1` materializer:

```bash
jq . configs/h001/manifests/h001_expanded_retrieval_deeper_backend_generation_v1.json
jq . configs/h001/manifests/h001_expanded_retrieval_goal_validity_confirmation_v1.json
jq . configs/h001/manifests/h001_expanded_retrieval_goal_validity_evidence_v1.json
jq . configs/h001/manifests/h001_expanded_retrieval_goal_validity_objective_v1.json
jq . configs/h001/manifests/h001_expanded_retrieval_goal_validity_full_substrate_v1.json
jq . configs/h001/manifests/h001_expanded_retrieval_goal_validity_objective_full_v1.json
jq . configs/h001/manifests/h001_expanded_retrieval_goal_validity_ambiguity_resolution_v1.json
jq . configs/h001/manifests/h001_expanded_retrieval_pool_validity_branch_v1.json
...
```bash
bash scripts/h001_jobs/dense_backend_recall_y9h_chair.sh
...
tmux new-session -d -s "h001-openvocab-v3c-setup-${ts}" \
  "cd /home/yoohyun/research3 && \
   mkdir -p archive/logs/h001_runtime && \
   LOG_FILE=archive/logs/h001_runtime/openvocab-perception-v3c-groundingdino-sam2-${ts}.log \
   bash scripts/h001_jobs/openvocab_perception_v3c_groundingdino_sam2_setup.sh"
```
...
tmux new-session -d -s "h001-dense-conflict-artifact-canonical-${ts}" \
  "cd /home/yoohyun/research3 && TS=${ts} DATA_ROOT=/home/yoohyun/research3/local_dataset/data RUNS_ROOT=/home/yoohyun/research3/local_dataset/runs MODEL_ROOT=/home/yoohyun/research3/local_dataset/models bash scripts/h001_jobs/dense_conflict_candidate_artifact.sh"
```
...
bash scripts/h001_jobs/dense_conflict_validation_from_source.sh
```
...
```bash
jq . configs/h001/manifests/h001_dense_conflict_terminal_independent_v1.json >/dev/null
```
...
```bash
jq . configs/h001/manifests/h001_rival_identity_observation_v1.json >/dev/null
```
...
tmux new-session -d -s "h001-risk-validation-p97-k20-${ts}" \
  "cd /home/yoohyun/research3 && \
   TS=${ts} \
   MANIFEST=configs/h001/manifests/h001_risk_validation_v1.json \
   MANIFEST_SPLIT=risk_validation_v1 \
   SCENE_SPECS_FILE=configs/h001/manifests/risk_validation_v1_scenes.txt \
   ...
   bash scripts/h001_jobs/v3_fresh_validation_candidate_artifact_coverage.sh"
```
...
docker run --rm --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.analyze_expanded_retrieval_deeper_backend_generation \
    --contract /workspace/configs/h001/manifests/h001_expanded_retrieval_deeper_backend_generation_v1.json \
    ...
    --candidate-artifact /runs/h001_v3_fresh_validation_artifacts_spatial_nms_p97_k20_v1/all_scenes_aligned.jsonl \
    --episode-manifest /workspace/configs/h001/manifests/h001_v3_fresh_validation_v1.json \
    --episode-manifest-split v3_fresh_validation_v1 \
    --data-root /data \
    --scene-spec-source /workspace/configs/h001/manifests/v3_fresh_validation_v1_scenes.txt \
...
tmux new-session -d -s "h001-deeper-backend-${ts}" \
  "cd /home/yoohyun/research3 && \
   TS=${ts} \
   bash scripts/h001_jobs/expanded_retrieval_deeper_backend_generation.sh"
```
...
docker run --rm --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.analyze_expanded_retrieval_goal_validity_confirmation \
    --contract /workspace/configs/h001/manifests/h001_expanded_retrieval_goal_validity_confirmation_v1.json \
...
docker run --rm --ipc=host \
  ...
  micromamba run -n base python -m h001_runtime.analyze_expanded_retrieval_goal_validity_evidence \
    --contract /workspace/configs/h001/manifests/h001_expanded_retrieval_goal_validity_objective_v1.json \
...
tmux new-session -d -s "h001-risk-v4b-ext-v2-holdout-${ts}" \
  "cd /home/yoohyun/research3 && \
   TS=${ts} \
   bash scripts/h001_jobs/risk_validation_pair_objective_v4b_external_candidate_v2_holdout.sh"
```
...
tmux new-session -d -s "h001-followup-full-${ts}" \
  "cd /home/yoohyun/research3 && \
   TS=${ts} \
   bash scripts/h001_jobs/risk_validation_external_candidate_followup_detector.sh"
```
...
| Detector explicit-candidate repair | `src/h001_runtime/detect_postview_groundingdino_sam2.py` | implemented, smoke pass | detector association now uses explicit frame `candidate_ids` / `second_observation_candidate_ids` before semantic tie-band fallback; smoke on branch `external_candidate:13` selects `[2,7,6,5,9,14]` from frame `candidate_ids`, including the two correct sofa candidates that the previous detector association dropped |
...
| Independent dense conflict validation manifest / recall gate | `configs/h001/manifests/h001_dense_conflict_v1.json` | implemented, Docker verified | added `build_dense_conflict_manifest.py` and `probe_dense_conflict_recall.py`; manifest verify output `configs/h001/manifests/h001_dense_conflict_v1.verify.json` has `ok true`, `rows 8`, `unique_episode_keys 8`; final selected-artifact primary recall output `local_dataset/runs/h001_dense_conflict_recall_gate_v3_fresh_spatial_p97_k20_primary_final_v1` passes with `6/6` correct candidates and recall@20 `1.0` |
| Dense conflict `spatial_nms_p95_k100_d10` artifact job | `scripts/h001_jobs/dense_conflict_candidate_artifact.sh` | completed, recall gate fail | canonical relaunch `h001-dense-conflict-artifact-canonical-20260523-140845`; artifact generation completed with `24` rows, `2400` candidates, and `1451` finite-position candidates; final recall gate failed with primary rows with correct `3/6`, recall@20 `0.5`, required rows with correct `4/6`; detector job remains blocked for this substrate |
| Dense conflict `spatial_nms_p90_k200_d5` artifact job | `scripts/h001_jobs/dense_conflict_candidate_artifact.sh` | completed, recall gate fail | tmux `h001-dense-conflict-artifact-p90-k200-d5-20260523-150036`; artifact generation completed with `24` rows, `4800` candidates, and `4241` finite-position candidates; final recall gate failed with primary rows with correct `3/6`, recall@20 `0.5`, required rows with correct `4/6`; detector job remains blocked for this substrate |
| Dense conflict selected-artifact detector/association validation | `local_dataset/runs/h001_dense_conflict_validation_v3_fresh_spatial_p97_k20_primary_v1/dense_terminal_arbitration_summary.json` | primary diagnostic pass | added `analyze_dense_conflict_validation.py` and `scripts/h001_jobs/dense_conflict_validation_from_source.sh`; materializes existing `v3_fresh` second-stage detector/association evidence; primary rows `6`, detector box `1.0`, SAM2 mask `1.0`, candidate association `0.8`, correct+wrong positive support `6/6`, commit/success/wrong/no-valid `5/5/0/0`, selected-correct improvement over source-selected `3`, `uses_gt_for_action false`; detector/association blocked is lifted only for selected `v3_fresh_spatial_p97_k20` diagnostic substrate |
...
| Dense conflict generalization fixed terminal validation | `local_dataset/runs/h001_dense_conflict_generalization_terminal_validation_v1/terminal_validation_summary.json` | same-split validation pass | added `configs/h001/manifests/h001_dense_conflict_terminal_guard_v1.json` and `validate_dense_conflict_terminal_arbitration.py`; action evidence forbidden key count `0`, stable metric match design `true`, local fixed-rule validation pass `true`, rows `20`, associated rows `7`, commit/success/wrong `3/3/0`, associated commit/success/wrong `3/3/0`, `uses_gt_for_action false`; paper claim status remains `same_split_fixed_rule_validation_not_method_claim` |
...
| Dense conflict rival identity fresh source manifest | `configs/h001/manifests/h001_rival_identity_generalization_v1.json` and `local_dataset/runs/h001_rival_identity_generalization_source_v1/source_summary.json` | frozen, source gate pass | added `build_rival_identity_generalization_manifest.py`; Docker `py_compile` and source freeze run passed; verify `configs/h001/manifests/h001_rival_identity_generalization_v1.verify.json` reports `ok true`; request rows `6`, request scenes `3`, request queries `2`, excluded-scene overlap `0`, action evidence forbidden key count `0`, `uses_gt_for_action false` |
...
| Dense conflict expanded retrieval branch contract | `configs/h001/manifests/h001_expanded_retrieval_branch_v1.json` | frozen, contract gate pass | uses router rows with `revision_action == request_expanded_retrieval`, expected request rows `8`, candidate budget `6-10`, forbidden action inputs include GT/evaluation labels and threshold tuning from joined labels, terminal commit is disabled, and candidate-set validity gates must pass before detector/objective work; `jq` validation passed |
