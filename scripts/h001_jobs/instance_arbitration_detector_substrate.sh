...
export PLAN_OUT=${PLAN_OUT:-${RUNS_ROOT}/h001_instance_arbitration_evidence_v1}
export FRAME_OUT=${FRAME_OUT:-${RUNS_ROOT}/h001_instance_arbitration_evidence_frames_v1}
...
export CANDIDATE_ARTIFACT=${CANDIDATE_ARTIFACT:-${PLAN_OUT}/instance_arbitration_candidate_artifact_rows.jsonl}
export OUT=${OUT:-${RUNS_ROOT}/h001_instance_arbitration_evidence_detector_substrate_v1}
export DETECTOR_OUT=${DETECTOR_OUT:-${OUT}/detector_v3c}
export LOG=${LOG:-${ROOT}/archive/logs/h001_runtime/instance-arbitration-detector-substrate-${TS}.log}
export STATUS=${STATUS:-${OUT}/job_status.json}

export EXPECTED_POLICY=${EXPECTED_POLICY:-InstanceArbitrationPairEvidence}
export EXPECTED_FRAME_ROWS=${EXPECTED_FRAME_ROWS:-172}
export MAX_FRAMES=${MAX_FRAMES:-172}
...
export MAX_DEBUG_IMAGES=${MAX_DEBUG_IMAGES:-360}
