...
export OUT=${OUT:-${RUNS_ROOT}/h001_expanded_retrieval_goal_validity_unique_support_rival_region_detector_substrate_repair_depth2_v1}
export DETECTOR_OUT=${DETECTOR_OUT:-${OUT}/detector_v3c}
export LOG=${LOG:-${ROOT}/archive/logs/h001_runtime/unique-support-rival-region-detector-substrate-repair-depth2-${TS}.log}
...
export ASSOCIATION_REPAIR_VARIANT=${ASSOCIATION_REPAIR_VARIANT:-mask_depth_2_0_v1}
export ASSOCIATION_DEPTH_TOLERANCE_M=${ASSOCIATION_DEPTH_TOLERANCE_M:-2.0}
