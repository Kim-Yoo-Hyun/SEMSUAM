...
export LOG=${LOG:-${ROOT}/archive/logs/h001_runtime/rival-contradiction-region-contamination-multi-case-detector-substrate-${TS}.log}
...
echo "command=TS=${TS} ROOT=${ROOT} ${HYP}/scripts/h001_jobs/rival_contradiction_region_contamination_multi_case_detector_substrate.sh" >> "${LOG}"
