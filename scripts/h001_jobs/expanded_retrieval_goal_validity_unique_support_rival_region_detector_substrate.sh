...
export OUT=${OUT:-${RUNS_ROOT}/h001_expanded_retrieval_goal_validity_unique_support_rival_region_detector_substrate_v1}
export DETECTOR_OUT=${DETECTOR_OUT:-${OUT}/detector_v3c}
export LOG=${LOG:-${ROOT}/archive/logs/h001_runtime/unique-support-rival-region-detector-substrate-${TS}.log}
