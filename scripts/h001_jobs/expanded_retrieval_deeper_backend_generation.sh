...
LOG=${LOG:-${ROOT}/archive/logs/h001_runtime/expanded-retrieval-deeper-backend-generation-${TS}.log}
...
payload = {
    ...
    "command": "TS=${TS} bash ${HYP}/scripts/h001_jobs/expanded_retrieval_deeper_backend_generation.sh",
    "contract": "${CONTRACT}",
...
paths = {
    ...
    "analyzer": Path("${HYP}/src/h001_runtime/analyze_expanded_retrieval_deeper_backend_generation.py"),
