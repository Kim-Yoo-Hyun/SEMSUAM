...
export LOG=${LOG:-${HYP}/runtime/logs/goal-region-object-relation-coverage-completion-detector-substrate-${TS}.log}
...
echo "command=TS=${TS} ROOT=${ROOT} ${HYP}/runtime/jobs/goal_region_object_relation_coverage_completion_detector_substrate.sh" >> "${LOG}"
