...
LOG=${LOG:-${HYP}/runtime/logs/goal-validity-full-substrate-${TS}.log}
...
payload = {
    ...
    "command": "TS=${TS} bash hypothesis/CAND-01/H001_uncertainty-reobservation/runtime/jobs/expanded_retrieval_goal_validity_full_substrate.sh",
