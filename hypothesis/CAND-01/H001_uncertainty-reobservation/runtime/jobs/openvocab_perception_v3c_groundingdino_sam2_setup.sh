...
RUNTIME_DIR="$ROOT_DIR/hypothesis/CAND-01/H001_uncertainty-reobservation/runtime"
...
LOG_FILE="${LOG_FILE:-$ROOT_DIR/logs/openvocab-perception-v3c-groundingdino-sam2-$(date +%Y%m%d-%H%M%S).log}"
...
sg docker -c "docker build -f '$RUNTIME_DIR/Dockerfile.openvocab-perception-v3c' -t '$IMAGE' '$ROOT_DIR'"
