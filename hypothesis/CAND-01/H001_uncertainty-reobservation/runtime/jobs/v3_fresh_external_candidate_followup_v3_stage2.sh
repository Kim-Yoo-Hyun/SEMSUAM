...
LOG=${LOG:-${HYP}/runtime/logs/v3-fresh-external-candidate-followup-v3-stage2-${TS}.log}
...
payload = {
    ...
    "exact_command": "TS=${TS} bash ${HYP}/runtime/jobs/v3_fresh_external_candidate_followup_v3_stage2.sh",
...
echo "exact_command=TS=${TS} bash ${HYP}/runtime/jobs/v3_fresh_external_candidate_followup_v3_stage2.sh"
