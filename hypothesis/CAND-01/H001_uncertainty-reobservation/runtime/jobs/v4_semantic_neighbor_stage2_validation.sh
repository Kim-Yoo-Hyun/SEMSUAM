...
LOG=${LOG:-${HYP}/runtime/logs/v4-semantic-neighbor-stage2-validation-${TS}.log}
...
payload = {
    ...
    "exact_command": "TS=${TS} bash ${HYP}/runtime/jobs/v4_semantic_neighbor_stage2_validation.sh",
...
echo "exact_command=TS=${TS} bash ${HYP}/runtime/jobs/v4_semantic_neighbor_stage2_validation.sh"
