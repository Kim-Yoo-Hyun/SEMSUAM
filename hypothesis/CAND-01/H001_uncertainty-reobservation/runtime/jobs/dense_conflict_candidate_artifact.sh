...
LOG=${LOG:-${HYP}/runtime/logs/dense-conflict-artifact-p95-k100-d10-${TS}.log}
...
command: TS=${TS} bash ${HYP}/runtime/jobs/dense_conflict_candidate_artifact.sh
manifest: ${MANIFEST}
manifest_split: ${MANIFEST_SPLIT}
scene_specs_file: ${SCENE_SPECS_FILE}
artifact_out: ${ARTIFACT_OUT}
...
paths = {
    ...
    "recall_gate": Path("${HYP}/runtime/h001_runtime/probe_dense_conflict_recall.py"),
}
