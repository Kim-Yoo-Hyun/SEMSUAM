...
LOG=${LOG:-${HYP}/runtime/logs/expanded-retrieval-pool-validity-second-fallback-${TS}.log}
...
payload = {
    ...
    "command": "TS=${TS} bash ${HYP}/runtime/jobs/expanded_retrieval_pool_validity_second_fallback.sh",
    "contract": "${CONTRACT}",
...
paths = {
    ...
    "analyzer": Path("${HYP}/runtime/h001_runtime/analyze_expanded_retrieval_pool_validity_second_fallback.py"),
